...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LandMinePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function LandMinePrototype.process(_, rules)
  --- @type LIVR.Rules
