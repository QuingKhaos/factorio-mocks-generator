...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TransportBeltConnectablePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function TransportBeltConnectablePrototype.process(_, rules)
  --- @type LIVR.Rules
...
return TransportBeltConnectablePrototype
