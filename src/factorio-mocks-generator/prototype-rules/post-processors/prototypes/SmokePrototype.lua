...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SmokePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function SmokePrototype.process(_, rules)
  --- @type LIVR.Rules
