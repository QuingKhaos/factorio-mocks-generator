...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemGroup: factorio_mocks_generator.prototype_rules.post_processors.prototypes
local ItemGroup = {}
...
function ItemGroup.process(_, rules)
  --- @type LIVR.Rules
