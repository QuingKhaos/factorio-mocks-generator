...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CargoBayPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function CargoBayPrototype.process(_, rules)
  --- @type LIVR.Rules
