...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.DisplayPanelPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function DisplayPanelPrototype.process(_, rules)
  --- @type LIVR.Rules
