...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TransportBeltPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.TransportBeltConnectablePrototype
...
function TransportBeltPrototype.process(_, rules)
  --- @type LIVR.Rules
