...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.FusionGeneratorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function FusionGeneratorPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return FusionGeneratorPrototype
