...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.DontUseEntityInEnergyProductionAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototypeWithCondition
...
function DontUseEntityInEnergyProductionAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return DontUseEntityInEnergyProductionAchievementPrototype
