...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TurretPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function TurretPrototype.process(_, rules)
  --- @type LIVR.Rules
