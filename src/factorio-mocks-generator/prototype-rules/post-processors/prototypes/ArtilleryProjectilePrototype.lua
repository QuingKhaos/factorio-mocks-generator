...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ArtilleryProjectilePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function ArtilleryProjectilePrototype.process(_, rules)
  --- @type LIVR.Rules
