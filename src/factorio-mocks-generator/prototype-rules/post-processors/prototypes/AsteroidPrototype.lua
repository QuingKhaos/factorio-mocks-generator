...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.AsteroidPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function AsteroidPrototype.process(_, rules)
  --- @type LIVR.Rules
