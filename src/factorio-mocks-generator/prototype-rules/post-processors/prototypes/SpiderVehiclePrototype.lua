...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SpiderVehiclePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.VehiclePrototype
...
function SpiderVehiclePrototype.process(_, rules)
  --- @type LIVR.Rules
