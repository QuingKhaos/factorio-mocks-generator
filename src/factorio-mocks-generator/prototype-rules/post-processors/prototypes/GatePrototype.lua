...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.GatePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
local GatePrototype = {}
...
function GatePrototype.process(_, rules)
  --- @type LIVR.Rules
