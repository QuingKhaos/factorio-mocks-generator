...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.FusionReactorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function FusionReactorPrototype.process(_, rules)
  --- @type LIVR.Rules
