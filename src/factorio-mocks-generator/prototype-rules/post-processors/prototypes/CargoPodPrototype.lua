...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CargoPodPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function CargoPodPrototype.process(_, rules)
  --- @type LIVR.Rules
