...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
local ItemPrototype = {}
...
function ItemPrototype.process(_, rules)
  --- @type LIVR.Rules
