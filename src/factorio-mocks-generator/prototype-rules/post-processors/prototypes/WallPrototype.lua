...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.WallPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
local WallPrototype = {}
...
function WallPrototype.process(_, rules)
  --- @type LIVR.Rules
