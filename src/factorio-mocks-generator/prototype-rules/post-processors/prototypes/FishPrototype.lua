...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.FishPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithHealthPrototype
local FishPrototype = {}
...
function FishPrototype.process(_, rules)
  --- @type LIVR.Rules
