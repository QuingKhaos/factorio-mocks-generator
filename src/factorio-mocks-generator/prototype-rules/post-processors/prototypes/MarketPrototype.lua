...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.MarketPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function MarketPrototype.process(_, rules)
  --- @type LIVR.Rules
