...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototypeWithCondition: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function AchievementPrototypeWithCondition.process(_, rules)
  --- @type LIVR.Rules
...
return AchievementPrototypeWithCondition
