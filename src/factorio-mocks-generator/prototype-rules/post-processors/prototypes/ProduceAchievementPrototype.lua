...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ProduceAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function ProduceAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ProduceAchievementPrototype
