...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CombatRobotCountAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function CombatRobotCountAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return CombatRobotCountAchievementPrototype
