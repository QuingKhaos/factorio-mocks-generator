...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.DepleteResourceAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
local DepleteResourceAchievementPrototype = {}
...
function DepleteResourceAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return DepleteResourceAchievementPrototype
