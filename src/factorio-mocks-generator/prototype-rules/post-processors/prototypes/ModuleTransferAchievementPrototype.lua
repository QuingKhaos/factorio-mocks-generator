...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ModuleTransferAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function ModuleTransferAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ModuleTransferAchievementPrototype
