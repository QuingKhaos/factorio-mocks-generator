...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LaneSplitterPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.TransportBeltConnectablePrototype
...
function LaneSplitterPrototype.process(_, rules)
  --- @type LIVR.Rules
