...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.DeciderCombinatorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.CombinatorPrototype
...
function DeciderCombinatorPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return DeciderCombinatorPrototype
