...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SimpleEntityPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithHealthPrototype
...
function SimpleEntityPrototype.process(_, rules)
  --- @type LIVR.Rules
