...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.HeatPipePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function HeatPipePrototype.process(_, rules)
  --- @type LIVR.Rules
