...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.Loader1x2Prototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.LoaderPrototype
...
function Loader1x2Prototype.process(_, rules)
  --- @type LIVR.Rules
