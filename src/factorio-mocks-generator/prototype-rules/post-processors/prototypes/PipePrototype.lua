...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.PipePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
local PipePrototype = {}
...
function PipePrototype.process(_, rules)
  --- @type LIVR.Rules
