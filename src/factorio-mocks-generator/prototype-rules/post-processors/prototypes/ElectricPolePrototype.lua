...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ElectricPolePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function ElectricPolePrototype.process(_, rules)
  --- @type LIVR.Rules
