...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ProjectilePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function ProjectilePrototype.process(_, rules)
  --- @type LIVR.Rules
