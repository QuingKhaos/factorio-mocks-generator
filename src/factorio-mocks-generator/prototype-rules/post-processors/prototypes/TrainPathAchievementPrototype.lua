...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TrainPathAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function TrainPathAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return TrainPathAchievementPrototype
