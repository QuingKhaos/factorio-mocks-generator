...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemWithLabelPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemPrototype
...
function ItemWithLabelPrototype.process(_, rules)
  --- @type LIVR.Rules
