...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ArrowPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function ArrowPrototype.process(_, rules)
  --- @type LIVR.Rules
