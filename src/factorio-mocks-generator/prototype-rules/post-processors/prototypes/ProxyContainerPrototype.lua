...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ProxyContainerPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function ProxyContainerPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ProxyContainerPrototype
