...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailPlannerPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemPrototype
...
function RailPlannerPrototype.process(_, rules)
  --- @type LIVR.Rules
