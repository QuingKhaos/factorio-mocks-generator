...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SurfacePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function SurfacePrototype.process(_, rules)
  --- @type LIVR.Rules
