...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailSupportPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function RailSupportPrototype.process(_, rules)
  --- @type LIVR.Rules
