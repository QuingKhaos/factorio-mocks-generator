...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ModulePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemPrototype
...
function ModulePrototype.process(_, rules)
  --- @type LIVR.Rules
