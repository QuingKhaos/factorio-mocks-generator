...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function EntityPrototype.process(_, rules)
  --- @type LIVR.Rules
