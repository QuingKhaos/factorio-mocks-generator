...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RocketSiloRocketPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function RocketSiloRocketPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return RocketSiloRocketPrototype
