...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ResearchAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function ResearchAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ResearchAchievementPrototype
