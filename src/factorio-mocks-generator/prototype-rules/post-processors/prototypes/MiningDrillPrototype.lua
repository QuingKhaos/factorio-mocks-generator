...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.MiningDrillPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function MiningDrillPrototype.process(_, rules)
  --- @type LIVR.Rules
