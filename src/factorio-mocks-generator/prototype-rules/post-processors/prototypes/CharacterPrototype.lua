...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CharacterPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function CharacterPrototype.process(_, rules)
  --- @type LIVR.Rules
