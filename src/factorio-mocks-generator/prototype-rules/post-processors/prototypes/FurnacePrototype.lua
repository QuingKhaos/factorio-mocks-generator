...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.FurnacePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.CraftingMachinePrototype
...
function FurnacePrototype.process(_, rules)
  --- @type LIVR.Rules
