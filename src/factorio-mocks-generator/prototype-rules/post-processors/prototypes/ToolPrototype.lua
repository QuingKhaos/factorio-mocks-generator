...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ToolPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemPrototype
local ToolPrototype = {}
...
function ToolPrototype.process(_, rules)
  --- @type LIVR.Rules
