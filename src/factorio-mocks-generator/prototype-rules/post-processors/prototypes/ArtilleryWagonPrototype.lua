...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ArtilleryWagonPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.RollingStockPrototype
...
function ArtilleryWagonPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ArtilleryWagonPrototype
