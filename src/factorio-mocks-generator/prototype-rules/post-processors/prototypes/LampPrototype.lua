...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LampPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
local LampPrototype = {}
...
function LampPrototype.process(_, rules)
  --- @type LIVR.Rules
