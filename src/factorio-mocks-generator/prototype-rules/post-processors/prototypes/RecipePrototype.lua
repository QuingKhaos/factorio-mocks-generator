...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RecipePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function RecipePrototype.process(_, rules)
  --- @type LIVR.Rules
