...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ConstantCombinatorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function ConstantCombinatorPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ConstantCombinatorPrototype
