...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ArithmeticCombinatorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.CombinatorPrototype
...
function ArithmeticCombinatorPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ArithmeticCombinatorPrototype
