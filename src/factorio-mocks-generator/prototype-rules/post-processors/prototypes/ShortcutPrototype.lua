...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ShortcutPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function ShortcutPrototype.process(_, rules)
  --- @type LIVR.Rules
