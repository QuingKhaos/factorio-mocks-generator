...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SpiderUnitPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function SpiderUnitPrototype.process(_, rules)
  --- @type LIVR.Rules
