...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LinkedBeltPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.TransportBeltConnectablePrototype
...
function LinkedBeltPrototype.process(_, rules)
  --- @type LIVR.Rules
