...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LightningAttractorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function LightningAttractorPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return LightningAttractorPrototype
