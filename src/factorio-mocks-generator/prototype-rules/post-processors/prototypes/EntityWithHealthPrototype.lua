...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithHealthPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function EntityWithHealthPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return EntityWithHealthPrototype
