...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CombinatorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function CombinatorPrototype.process(_, rules)
  --- @type LIVR.Rules
