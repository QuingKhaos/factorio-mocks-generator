...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ConstructionRobotPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.RobotWithLogisticInterfacePrototype
...
function ConstructionRobotPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ConstructionRobotPrototype
