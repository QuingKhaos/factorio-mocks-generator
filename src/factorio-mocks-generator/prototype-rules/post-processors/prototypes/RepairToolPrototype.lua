...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RepairToolPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.ToolPrototype
...
function RepairToolPrototype.process(_, rules)
  --- @type LIVR.Rules
