...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.HighlightBoxEntityPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function HighlightBoxEntityPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return HighlightBoxEntityPrototype
