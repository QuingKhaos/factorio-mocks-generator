...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TechnologyPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function TechnologyPrototype.process(_, rules)
  --- @type LIVR.Rules
