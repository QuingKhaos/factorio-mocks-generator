...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LightningPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function LightningPrototype.process(_, rules)
  --- @type LIVR.Rules
