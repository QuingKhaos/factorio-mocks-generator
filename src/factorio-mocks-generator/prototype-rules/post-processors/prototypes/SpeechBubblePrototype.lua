...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SpeechBubblePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function SpeechBubblePrototype.process(_, rules)
  --- @type LIVR.Rules
