...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TipsAndTricksItem: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function TipsAndTricksItem.process(_, rules)
  --- @type LIVR.Rules
