...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SpacePlatformHubPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function SpacePlatformHubPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return SpacePlatformHubPrototype
