...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailSignalBasePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function RailSignalBasePrototype.process(_, rules)
  --- @type LIVR.Rules
...
return RailSignalBasePrototype
