...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CurvedRailAPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailPrototype
...
function CurvedRailAPrototype.process(_, rules)
  --- @type LIVR.Rules
