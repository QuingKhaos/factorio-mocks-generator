...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SpiderLegPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function SpiderLegPrototype.process(_, rules)
  --- @type LIVR.Rules
