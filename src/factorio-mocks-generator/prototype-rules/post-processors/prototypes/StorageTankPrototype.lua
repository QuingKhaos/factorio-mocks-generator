...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.StorageTankPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function StorageTankPrototype.process(_, rules)
  --- @type LIVR.Rules
