...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CliffPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function CliffPrototype.process(_, rules)
  --- @type LIVR.Rules
