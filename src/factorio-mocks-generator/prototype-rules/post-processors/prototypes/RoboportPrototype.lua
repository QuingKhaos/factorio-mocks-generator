...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RoboportPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function RoboportPrototype.process(_, rules)
  --- @type LIVR.Rules
