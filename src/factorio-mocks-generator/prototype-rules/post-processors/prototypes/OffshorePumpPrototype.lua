...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.OffshorePumpPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function OffshorePumpPrototype.process(_, rules)
  --- @type LIVR.Rules
