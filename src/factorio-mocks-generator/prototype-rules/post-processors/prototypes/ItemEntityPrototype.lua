...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemEntityPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function ItemEntityPrototype.process(_, rules)
  --- @type LIVR.Rules
