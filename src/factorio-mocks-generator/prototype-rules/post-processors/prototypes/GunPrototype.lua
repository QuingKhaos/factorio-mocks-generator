...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.GunPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemPrototype
local GunPrototype = {}
...
function GunPrototype.process(_, rules)
  --- @type LIVR.Rules
