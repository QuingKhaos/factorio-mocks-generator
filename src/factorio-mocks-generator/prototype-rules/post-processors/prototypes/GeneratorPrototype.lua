...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.GeneratorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function GeneratorPrototype.process(_, rules)
  --- @type LIVR.Rules
