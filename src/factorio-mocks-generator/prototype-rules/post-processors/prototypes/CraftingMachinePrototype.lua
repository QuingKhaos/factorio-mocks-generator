...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CraftingMachinePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function CraftingMachinePrototype.process(_, rules)
  --- @type LIVR.Rules
