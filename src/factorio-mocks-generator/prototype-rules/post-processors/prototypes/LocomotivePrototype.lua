...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LocomotivePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.RollingStockPrototype
...
function LocomotivePrototype.process(_, rules)
  --- @type LIVR.Rules
