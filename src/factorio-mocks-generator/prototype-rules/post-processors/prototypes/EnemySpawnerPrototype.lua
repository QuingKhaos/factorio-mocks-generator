...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.EnemySpawnerPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function EnemySpawnerPrototype.process(_, rules)
  --- @type LIVR.Rules
