...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ArtilleryFlarePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function ArtilleryFlarePrototype.process(_, rules)
  --- @type LIVR.Rules
...
return ArtilleryFlarePrototype
