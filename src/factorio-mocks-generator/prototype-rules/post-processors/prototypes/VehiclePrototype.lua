...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.VehiclePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function VehiclePrototype.process(_, rules)
  --- @type LIVR.Rules
