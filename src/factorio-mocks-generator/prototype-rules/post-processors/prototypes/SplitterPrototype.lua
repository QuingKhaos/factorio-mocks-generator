...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SplitterPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.TransportBeltConnectablePrototype
...
function SplitterPrototype.process(_, rules)
  --- @type LIVR.Rules
