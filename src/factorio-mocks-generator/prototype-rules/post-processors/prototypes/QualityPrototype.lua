...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.QualityPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function QualityPrototype.process(_, rules)
  --- @type LIVR.Rules
