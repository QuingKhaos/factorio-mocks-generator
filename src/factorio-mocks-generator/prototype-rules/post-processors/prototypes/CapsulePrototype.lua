...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CapsulePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemPrototype
...
function CapsulePrototype.process(_, rules)
  --- @type LIVR.Rules
