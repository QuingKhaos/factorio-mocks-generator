...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SegmentPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function SegmentPrototype.process(_, rules)
  --- @type LIVR.Rules
