...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ExplosionPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function ExplosionPrototype.process(_, rules)
  --- @type LIVR.Rules
