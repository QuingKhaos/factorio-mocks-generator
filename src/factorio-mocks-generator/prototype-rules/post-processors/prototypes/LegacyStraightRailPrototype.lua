...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LegacyStraightRailPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailPrototype
...
function LegacyStraightRailPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return LegacyStraightRailPrototype
