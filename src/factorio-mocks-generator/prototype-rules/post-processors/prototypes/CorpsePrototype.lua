...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CorpsePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function CorpsePrototype.process(_, rules)
  --- @type LIVR.Rules
