...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CompleteObjectiveAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototypeWithCondition
...
function CompleteObjectiveAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return CompleteObjectiveAchievementPrototype
