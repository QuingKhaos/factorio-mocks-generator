...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.VirtualSignalPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function VirtualSignalPrototype.process(_, rules)
  --- @type LIVR.Rules
