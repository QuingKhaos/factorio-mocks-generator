...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SpaceConnectionPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function SpaceConnectionPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return SpaceConnectionPrototype
