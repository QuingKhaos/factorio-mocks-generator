...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.PumpPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
local PumpPrototype = {}
...
function PumpPrototype.process(_, rules)
  --- @type LIVR.Rules
