...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.HeatInterfacePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function HeatInterfacePrototype.process(_, rules)
  --- @type LIVR.Rules
