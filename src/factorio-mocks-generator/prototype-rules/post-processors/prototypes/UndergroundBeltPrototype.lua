...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.UndergroundBeltPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.TransportBeltConnectablePrototype
...
function UndergroundBeltPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return UndergroundBeltPrototype
