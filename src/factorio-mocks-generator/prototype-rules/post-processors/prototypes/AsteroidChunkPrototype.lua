...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.AsteroidChunkPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
...
function AsteroidChunkPrototype.process(_, rules)
  --- @type LIVR.Rules
