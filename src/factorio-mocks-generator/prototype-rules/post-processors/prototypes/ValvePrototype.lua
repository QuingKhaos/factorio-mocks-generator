...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ValvePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function ValvePrototype.process(_, rules)
  --- @type LIVR.Rules
