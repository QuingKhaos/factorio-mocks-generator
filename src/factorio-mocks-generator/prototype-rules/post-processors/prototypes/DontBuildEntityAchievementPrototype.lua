...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.DontBuildEntityAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototypeWithCondition
...
function DontBuildEntityAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return DontBuildEntityAchievementPrototype
