...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityGhostPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function EntityGhostPrototype.process(_, rules)
  --- @type LIVR.Rules
