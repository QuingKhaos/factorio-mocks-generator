...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.HalfDiagonalRailPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailPrototype
...
function HalfDiagonalRailPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return HalfDiagonalRailPrototype
