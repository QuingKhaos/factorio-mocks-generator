...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ContainerPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function ContainerPrototype.process(_, rules)
  --- @type LIVR.Rules
