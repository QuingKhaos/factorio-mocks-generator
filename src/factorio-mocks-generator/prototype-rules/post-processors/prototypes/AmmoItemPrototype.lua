...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.AmmoItemPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.ItemPrototype
...
function AmmoItemPrototype.process(_, rules)
  --- @type LIVR.Rules
