...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TrainStopPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function TrainStopPrototype.process(_, rules)
  --- @type LIVR.Rules
