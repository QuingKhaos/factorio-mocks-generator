...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.InserterPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function InserterPrototype.process(_, rules)
  --- @type LIVR.Rules
