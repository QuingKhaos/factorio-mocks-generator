...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RadarPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function RadarPrototype.process(_, rules)
  --- @type LIVR.Rules
