...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.AmmoCategory: factorio_mocks_generator.prototype_rules.post_processors.prototypes
local AmmoCategory = {}
...
function AmmoCategory.process(_, rules)
  --- @type LIVR.Rules
