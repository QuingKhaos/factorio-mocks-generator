...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LegacyCurvedRailPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailPrototype
...
function LegacyCurvedRailPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return LegacyCurvedRailPrototype
