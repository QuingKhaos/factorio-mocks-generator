...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ThrusterPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function ThrusterPrototype.process(_, rules)
  --- @type LIVR.Rules
