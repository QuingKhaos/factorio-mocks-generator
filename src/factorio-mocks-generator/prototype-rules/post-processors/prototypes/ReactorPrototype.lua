...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.ReactorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function ReactorPrototype.process(_, rules)
  --- @type LIVR.Rules
