...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.PipeToGroundPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function PipeToGroundPrototype.process(_, rules)
  --- @type LIVR.Rules
