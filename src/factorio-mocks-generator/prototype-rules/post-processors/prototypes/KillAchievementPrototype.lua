...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.KillAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function KillAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return KillAchievementPrototype
