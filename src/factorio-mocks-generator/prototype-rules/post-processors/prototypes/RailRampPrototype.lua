...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailRampPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailPrototype
...
function RailRampPrototype.process(_, rules)
  --- @type LIVR.Rules
