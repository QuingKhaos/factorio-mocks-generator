...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CombatRobotPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.FlyingRobotPrototype
...
function CombatRobotPrototype.process(_, rules)
  --- @type LIVR.Rules
