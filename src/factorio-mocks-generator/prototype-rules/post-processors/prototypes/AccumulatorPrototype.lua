...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.AccumulatorPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function AccumulatorPrototype.process(_, rules)
  --- @type LIVR.Rules
