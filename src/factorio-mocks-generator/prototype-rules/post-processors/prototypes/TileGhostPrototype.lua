...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TileGhostPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function TileGhostPrototype.process(_, rules)
  --- @type LIVR.Rules
