...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.BeamPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
local BeamPrototype = {}
...
function BeamPrototype.process(_, rules)
  --- @type LIVR.Rules
