...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.StickerPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function StickerPrototype.process(_, rules)
  --- @type LIVR.Rules
