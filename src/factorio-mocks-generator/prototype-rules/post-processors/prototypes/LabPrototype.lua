...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.LabPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
local LabPrototype = {}
...
function LabPrototype.process(_, rules)
  --- @type LIVR.Rules
