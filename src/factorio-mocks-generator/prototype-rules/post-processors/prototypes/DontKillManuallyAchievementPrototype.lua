...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.DontKillManuallyAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototypeWithCondition
...
function DontKillManuallyAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return DontKillManuallyAchievementPrototype
