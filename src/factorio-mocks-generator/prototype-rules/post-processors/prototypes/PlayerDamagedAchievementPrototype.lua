...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.PlayerDamagedAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function PlayerDamagedAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return PlayerDamagedAchievementPrototype
