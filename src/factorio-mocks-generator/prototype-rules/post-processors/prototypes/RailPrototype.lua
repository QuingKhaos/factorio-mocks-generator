...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RailPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
local RailPrototype = {}
...
function RailPrototype.process(_, rules)
  --- @type LIVR.Rules
