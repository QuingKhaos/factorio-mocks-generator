...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.PlayerPortPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function PlayerPortPrototype.process(_, rules)
  --- @type LIVR.Rules
