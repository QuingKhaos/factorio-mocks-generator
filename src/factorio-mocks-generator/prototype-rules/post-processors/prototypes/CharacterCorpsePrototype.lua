...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.CharacterCorpsePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityPrototype
...
function CharacterCorpsePrototype.process(_, rules)
  --- @type LIVR.Rules
...
return CharacterCorpsePrototype
