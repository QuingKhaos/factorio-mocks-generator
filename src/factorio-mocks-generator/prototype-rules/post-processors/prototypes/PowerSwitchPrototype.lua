...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.PowerSwitchPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function PowerSwitchPrototype.process(_, rules)
  --- @type LIVR.Rules
