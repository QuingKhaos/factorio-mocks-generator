...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.TilePrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes
local TilePrototype = {}
...
function TilePrototype.process(_, rules)
  --- @type LIVR.Rules
