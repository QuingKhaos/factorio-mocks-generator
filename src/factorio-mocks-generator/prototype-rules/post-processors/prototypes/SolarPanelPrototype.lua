...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.SolarPanelPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.EntityWithOwnerPrototype
...
function SolarPanelPrototype.process(_, rules)
  --- @type LIVR.Rules
