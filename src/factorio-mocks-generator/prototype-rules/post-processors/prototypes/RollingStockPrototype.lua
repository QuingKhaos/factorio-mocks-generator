...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.RollingStockPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.VehiclePrototype
...
function RollingStockPrototype.process(_, rules)
  --- @type LIVR.Rules
