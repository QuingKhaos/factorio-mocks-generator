...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.PlaceEquipmentAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototype
...
function PlaceEquipmentAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return PlaceEquipmentAchievementPrototype
