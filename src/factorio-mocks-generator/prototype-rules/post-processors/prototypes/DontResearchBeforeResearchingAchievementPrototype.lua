...
--- @class factorio_mocks_generator.prototype_rules.post_processors.prototypes.DontResearchBeforeResearchingAchievementPrototype: factorio_mocks_generator.prototype_rules.post_processors.prototypes.AchievementPrototypeWithCondition
...
function DontResearchBeforeResearchingAchievementPrototype.process(_, rules)
  --- @type LIVR.Rules
...
return DontResearchBeforeResearchingAchievementPrototype
