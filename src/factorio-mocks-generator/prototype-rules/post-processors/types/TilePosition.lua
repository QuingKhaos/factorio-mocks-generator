...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.TilePosition: factorio_mocks_generator.prototype_rules.post_processors.types
local TilePosition = {}
...
function TilePosition.process(_, rules)
