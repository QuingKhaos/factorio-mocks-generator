...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.Color: factorio_mocks_generator.prototype_rules.post_processors.types
local Color = {}
...
function Color.process(_, rules)
