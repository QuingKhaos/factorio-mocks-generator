...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.RangedValue: factorio_mocks_generator.prototype_rules.post_processors.types
local RangedValue = {}
...
function RangedValue.process(_, rules)
