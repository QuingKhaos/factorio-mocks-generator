...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.Vector3D: factorio_mocks_generator.prototype_rules.post_processors.types
local Vector3D = {}
...
function Vector3D.process(_, rules)
