...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.ThrusterPerformancePoint: factorio_mocks_generator.prototype_rules.post_processors.types
local ThrusterPerformancePoint = {}
...
function ThrusterPerformancePoint.process(_, rules)
  return shared.add_metadata_oneline_to_union_tuples(rules)
end

return ThrusterPerformancePoint
