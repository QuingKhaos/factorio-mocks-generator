...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.FluidProductPrototype: factorio_mocks_generator.prototype_rules.post_processors.types
...
function FluidProductPrototype.process(_, rules)
  --- @type LIVR.Rules
