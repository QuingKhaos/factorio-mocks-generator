...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.RandomRange: factorio_mocks_generator.prototype_rules.post_processors.types
local RandomRange = {}
...
function RandomRange.process(_, rules)
