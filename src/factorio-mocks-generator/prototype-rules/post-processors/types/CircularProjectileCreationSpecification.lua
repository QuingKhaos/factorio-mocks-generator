...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.CircularProjectileCreationSpecification: factorio_mocks_generator.prototype_rules.post_processors.types
local CircularProjectileCreationSpecification = {}
...
function CircularProjectileCreationSpecification.process(_, rules)
  return {
    list_of = shared.add_metadata_oneline_to_tuple(rules.list_of)
  }
end

return CircularProjectileCreationSpecification
