...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.RailPictureSet: factorio_mocks_generator.prototype_rules.post_processors.types
...
function RailPictureSet.process(_, rules)
  --- @type LIVR.Rules
