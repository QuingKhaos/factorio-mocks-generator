...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.SpawnPoint: factorio_mocks_generator.prototype_rules.post_processors.types
local SpawnPoint = {}
...
function SpawnPoint.process(_, rules)
