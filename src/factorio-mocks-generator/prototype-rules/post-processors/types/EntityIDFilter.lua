...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.EntityIDFilter: factorio_mocks_generator.prototype_rules.post_processors.types
...
function EntityIDFilter.process(_, rules)
  --- @type LIVR.Rules
