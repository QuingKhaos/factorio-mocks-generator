...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.CreateExplosionTriggerEffectItem: factorio_mocks_generator.prototype_rules.post_processors.types.CreateEntityTriggerEffectItem
...
function CreateExplosionTriggerEffectItem.process(_, rules)
  --- @type LIVR.Rules
...
return CreateExplosionTriggerEffectItem
