...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.Vector: factorio_mocks_generator.prototype_rules.post_processors.types
local Vector = {}
...
function Vector.process(_, rules)
