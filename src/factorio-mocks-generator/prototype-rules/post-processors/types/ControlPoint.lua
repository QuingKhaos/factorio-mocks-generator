...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.ControlPoint: factorio_mocks_generator.prototype_rules.post_processors.types
local ControlPoint = {}
...
function ControlPoint.process(_, rules)
