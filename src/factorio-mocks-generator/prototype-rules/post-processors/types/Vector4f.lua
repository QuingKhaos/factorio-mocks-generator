...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.Vector4f: factorio_mocks_generator.prototype_rules.post_processors.types
local Vector4f = {}
...
function Vector4f.process(_, rules)
