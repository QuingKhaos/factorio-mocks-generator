...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.TileIDRestriction: factorio_mocks_generator.prototype_rules.post_processors.types
local TileIDRestriction = {}
...
function TileIDRestriction.process(_, rules)
  return shared.add_metadata_oneline_to_union_tuples(rules)
end

return TileIDRestriction
