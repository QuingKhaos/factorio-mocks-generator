...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.BoundingBox: factorio_mocks_generator.prototype_rules.post_processors.types
local BoundingBox = {}
...
function BoundingBox.process(_, rules)
