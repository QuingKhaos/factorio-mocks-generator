...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.CreateFireTriggerEffectItem: factorio_mocks_generator.prototype_rules.post_processors.types.CreateEntityTriggerEffectItem
...
function CreateFireTriggerEffectItem.process(_, rules)
  --- @type LIVR.Rules
...
return CreateFireTriggerEffectItem
