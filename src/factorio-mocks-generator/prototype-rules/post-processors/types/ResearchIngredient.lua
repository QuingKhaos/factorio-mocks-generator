...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.ResearchIngredient: factorio_mocks_generator.prototype_rules.post_processors.types
...
function ResearchIngredient.process(_, rules)
