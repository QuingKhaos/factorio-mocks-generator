...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.VariableAmbientSoundLayerSample: factorio_mocks_generator.prototype_rules.post_processors.types
local VariableAmbientSoundLayerSample = {}
...
function VariableAmbientSoundLayerSample.process(_, rules)
  return shared.add_metadata_oneline_to_tuple(rules)
end

return VariableAmbientSoundLayerSample
