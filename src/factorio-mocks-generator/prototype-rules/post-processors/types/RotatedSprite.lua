...
--- @class factorio_mocks_generator.prototype_rules.post_processors.types.RotatedSprite: factorio_mocks_generator.prototype_rules.post_processors.types.SpriteParameters
local RotatedSprite = {}
...
function RotatedSprite.process(_, rules)
  --- @type LIVR.Rules
  ...
  new_rules.filenames.ignored_if[1] = {new_rules.filenames.ignored_if[1] --[[@as string]], "filename"}
