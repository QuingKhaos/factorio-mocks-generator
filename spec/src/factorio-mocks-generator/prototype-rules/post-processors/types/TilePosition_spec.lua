insulate("[#UNIT] prototype-rules.post-processors.types.TilePosition", function()
  local post_processor = require("factorio-mocks-generator.prototype-rules.post-processors.types.TilePosition")
