insulate("[#UNIT] prototype-rules.post-processors.types.TileIDRestriction", function()
  local post_processor = require("factorio-mocks-generator.prototype-rules.post-processors.types.TileIDRestriction")
