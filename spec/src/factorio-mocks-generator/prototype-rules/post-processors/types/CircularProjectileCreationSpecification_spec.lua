insulate("[#UNIT] prototype-rules.post-processors.types.CircularProjectileCreationSpecification", function()
  -- luacheck: no max line length
  local post_processor = require("factorio-mocks-generator.prototype-rules.post-processors.types.CircularProjectileCreationSpecification")
