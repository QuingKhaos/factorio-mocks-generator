insulate("[#UNIT] prototype-rules.post-processors.types.Color", function()
  local post_processor = require("factorio-mocks-generator.prototype-rules.post-processors.types.Color")
